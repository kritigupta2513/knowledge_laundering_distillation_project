...
import logging
from utils import SaveLoraCallback
...
model_id =  "meta-llama/Llama-3.2-1B" #"TinyLlama/TinyLlama-1.1B-Chat-v1.0" 
...
# dataset1 = load_dataset("json", data_files="datasets/mt_teacher_dataset.jsonl")
# dataset2 = load_dataset("json", data_files="datasets/mt_test_dataset.jsonl")
dataset = load_from_disk("datasets/epoch_datasets/epoch_5") # Use pre-generated distilled dataset
...
train_dataset = train_data.map(format_translation_prompt, remove_columns=["id", "translation","teacher_translation"])
eval_dataset = eval_data.map(format_translation_prompt, remove_columns=["id", "translation","teacher_translation"])
print(train_dataset[0])

# 4. Set training arguments
training_args = TrainingArguments(
    output_dir="./llama-sequence-distilled-epoch5",
...
model.save_pretrained("./models/epoch_sequence/epoch_5/adapter")
